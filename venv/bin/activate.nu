...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/annabrynkina/PycharmProjects/store-server/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/annabrynkina/PycharmProjects/store-server/venv/bin/deactivate.nu'
